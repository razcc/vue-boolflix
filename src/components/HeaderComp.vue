<template>
	<header>
		...
		<div class="colRight">
			<!-- Search -->
			<div class="btn-group dropstart search">
				<font-awesome-icon
					icon="fa-solid fa-magnifying-glass dropdown-toggle"
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					...
					<div class="disconetti">
						<a href="#">Esci da Netflix</a>
					</div>
				</div>
			</div>
		</div>
